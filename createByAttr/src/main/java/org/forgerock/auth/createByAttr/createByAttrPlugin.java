 ...
 * @since AM 5.5.0
 */
public class createByAttrPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(createByAttrPlugin.currentVersion, 
				Collections.singletonList(createByAttr.class));
	}
	...
	public String getPluginVersion() {
		return createByAttrPlugin.currentVersion;
	}
}
